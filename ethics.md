...
2. non_consensual (no informed agreement)
3. destroys_future_choice (removes agency going forward)
...
2. **correct to appropriate stance for current situation**
   - adapt to actual needs
   - do not rigidly enforce prior declaration
   
3. **proceed with adapted stance**
   - continue operating under corrected stance
   
4. **pattern adjusts for future through adaptation (not rigid logging)**
   - learn from mismatch
